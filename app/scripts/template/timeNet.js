...
networkFriends = [
    {
        "nodes": [
            {"id": 1, date: new Date(2008, 8, 4), "name": "Item 1"},
            {"id": 2, date: new Date(2009, 1, 1), "name": "Items 2"},
            {"id": 3, date: new Date(2010, 5, 14), "name": "Item 3"},
            {"id": 4, date: new Date(2011, 7, 14), "name": "Items 4"},
            {"id": 5, date: new Date(2012, 11, 1), "name": "items 5"},
            {"id": 6, date: new Date(2013, 8, 20), "name": "Item 6"}
        ],
        "links": [
            ...
            {"id": 5, "source": 3, "target": 6, date: new Date(2014, 3, 14) }
        ]
...
function configureTimeLine(){
    ...
    positionDate = new Date(2010,4,1);
    actualDate = new Date();
